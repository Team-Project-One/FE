...
const SignupLandingScreen: React.FC<SignupLandingScreenProps> = ({ onNavigate }) => {
  ...
  useEffect(() => {
    ...
    if (isNextImageLoaded && !isTransitioningRef.current && nextImageIndex !== currentIndexRef.current) {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.contentWrapper}>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.subText}>어딘가에 당신을 기다리는 사람이 있습니다.</Text>
          <Text style={styles.subText}>그 사람 또한 당신을 애타게 찾고 있을지 모릅니다.</Text>
