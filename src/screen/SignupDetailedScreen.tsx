          ...
          <View style={styles.formContainer}>
            ...
            <View style={styles.inputGroup}>
              ...
              >
                <Text
                  style={
                    formData.region ? styles.inputText : styles.inputPlaceholder
                  }
                >
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={styles.twoColumnContainer}>
                <View style={styles.buttonRow}>
                  <TouchableOpacity
                    onPress={() =>
                      handleSelection("drinkingFrequency", "안 마심")
                    }
                    style={[
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      handleSelection("drinkingFrequency", "주 1회 이하")
                    }
                    style={[
                      styles.selectionButton,
                ...
                <View style={styles.buttonRow}>
                  <TouchableOpacity
                    onPress={() =>
                      handleSelection("drinkingFrequency", "주 1-2회")
                    }
                    style={[
                      styles.selectionButton,
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      handleSelection("drinkingFrequency", "주 3회 이상")
                    }
                    style={[
                      styles.selectionButton,
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={styles.twoColumnContainer}>
                <View style={styles.buttonRow}>
                  <TouchableOpacity
                    onPress={() =>
                      handleSelection("contactFrequency", "중요함")
                    }
                    style={[
                      styles.selectionButton,
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      handleSelection("contactFrequency", "중요하지 않음")
                    }
                    style={[
                      styles.selectionButton,
