 ...
 */
const SignupSelfIntroScreen: React.FC<SignupSelfIntroScreenProps> = ({
  onNavigate,
}) => {
        ...
        <View style={[styles.progressHeader, { paddingTop: insets.top + 20 }]}>
          ...
          <View style={styles.headerRow}>
            <TouchableOpacity
              ...
              onPress={() => onNavigate("signupDetailed")}
            >
            ...
            <View style={styles.tipsBox}>
              ...
              <View style={styles.tipItem}>
                <Text style={styles.tipText}>
                  · 자신의 성격과 취미를 간단히 소개해보세요
                </Text>
              </View>
              <View style={styles.tipItem}>
                <Text style={styles.tipText}>
                  · 이상형이나 원하는 관계에 대해 언급하세요
                </Text>
              </View>
              <View style={styles.tipItem}>
                <Text style={styles.tipText}>
                  · 진솔하고 긍정적인 내용이 좋은 인상을 줍니다
                </Text>
              </View>
              <View style={styles.tipItem}>
                <Text style={styles.tipText}>
